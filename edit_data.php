...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update_query = "UPDATE perpus_umtas SET title = '$new_title', author = '$new_author', published_year = '$new_publish_year', isbn = '$new_isbn' WHERE id = '$id_to_update'";
...
$stmt = $conn->prepare("SELECT id, title, author, published_year, isbn FROM perpus_umtas WHERE id = ?");
